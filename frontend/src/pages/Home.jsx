...
import { Container, ImageContainer, Image, InfoContainer, Title, Info, Button, DescriptionContainer, DescTitle, Description } from '../styles/Home.style.jsx';
    ...
    return (
        <Container>
            ...
            <DescriptionContainer>
                <Image src="https://i.etsystatic.com/22211647/r/il/f47376/2400360110/il_570xN.2400360110_4iwx.jpg"/>
            ...
            <body class="center">
                <a onClick={() => handleShopNow()} class="shop-now-button">Shop Now</a>
            </body>
            <Footer />
        </Container>
    );
